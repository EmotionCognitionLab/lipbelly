...
const subject = 'USC Mind-Body Study Next Steps';
const msgText = (envelopeId) => `Thank you for signing the USC Mind-Body Study consent form. 
The next step is to create an account on the USC Mind-Body Study website so you can 
